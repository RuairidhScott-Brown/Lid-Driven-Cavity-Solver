...
SolverCG::Solve(double* b, double* x) 
{
    ...
    localDotProductEps = cblas_ddot(m_width*m_height, &m_localArrayB[m_height], 1, &m_localArrayB[m_height], 1);
    ...
    cblas_dtbmv(CblasRowMajor, CblasUpper, CblasNoTrans, CblasNonUnit, m_l, 0, m_localBC, 1, m_r, 1);
    ...
    cblas_dcopy(m_l, m_localArrayZ, 1, m_localArrayP, 1);        // p_0 = r_0
    ...
    do {
        ...
        localDotProductAplha = cblas_ddot(m_width*m_height, &m_localArrayT[m_height], 1, &m_localArrayP[m_height], 1);  // alpha = p_k^T A p_k
        localDotProductBeta = cblas_ddot(m_width*m_height, &m_localArrayR[m_height], 1, &m_localArrayZ[m_height], 1);  // alpha = p_k^T A p_k
        ...
        localDotProductEps = cblas_ddot(m_width*m_height, &m_localArrayR[m_height], 1, &m_localArrayR[m_height], 1);
        MPI_Allreduce(&localDotProductEps, &globalDotProductEps, 1, MPI_DOUBLE, MPI_SUM, m_solver_comm);
        ...
        cblas_dsbmv(CblasColMajor, CblasUpper, m_l, 0, 1.0, m_localPre, 1, m_localArrayR, 1, 0.0, m_localArrayZ, 1);
        localDotProductTemp = cblas_ddot(m_width*m_height, &m_localArrayR[m_height], 1, &m_localArrayZ[m_height], 1);
